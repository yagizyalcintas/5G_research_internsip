classdef (Abstract) nrNode < wirelessnetwork.internal.wirelessNode & comm.internal.ConfigBase
    ...
    methods
        ...
        function addTrafficSource(obj, trafficSource, varargin)
            ...
            %   addTrafficSource(OBJ, TRAFFICSOURCE) adds a data traffic
            %   source object, TRAFFICSOURCE, to the node, OBJ.
            %   TRAFFICSOURCE is an object of type <a
            %   href="matlab:help('networkTrafficOnOff')">networkTrafficOnOff</a>, <a href="matlab:help('networkTrafficFTP')">networkTrafficFTP</a>,
            %   <a href="matlab:help('networkTrafficVoIP')">networkTrafficVoIP</a>, or <a href="matlab:help('networkTrafficVideoConference')">networkTrafficVideoConference</a>.
    ...
    methods(Hidden)
        ...
        function processEvents(obj, eventName, data)
            ...
            if event.hasListener(obj, eventName)
                data.CurrenTime = obj.CurrentTime;
