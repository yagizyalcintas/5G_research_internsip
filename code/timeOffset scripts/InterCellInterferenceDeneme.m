...
gNBOfInterestIdx = 2; % Specify a value between 1 and number of gNBs

gNBs = nrGNB(Position=gNBPositions,CarrierFrequency=2.5e9,ChannelBandwidth=10e6,SubcarrierSpacing=30e3,TransmitPower=32,ReceiveGain=11);
